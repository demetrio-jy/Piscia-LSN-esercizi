...
{
	return 1.0;
	//return exp(-(v-0.8)*(v-0.8)/(2*0.38)) + exp(-(v+0.8)*(v+0.8)/(2*0.38));
}

double variationalWaveFunction_second(double v)
{
	return 0;
	//return -exp(-(v-0.8)*(v-0.8)/(2*0.38))/0.47 + (v-0.8)*(v-0.8)/0.1444*exp(-(v-0.8)*(v-0.8)/(2*0.38)) -exp(-(v+0.8)*(v+0.8)/(2*0.38))/0.38 + (v+0.8)*(v+0.8)/0.1444*exp(-(v+0.8)*(v+0.8)/(2*0.38));
}
